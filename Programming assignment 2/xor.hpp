...
{
public:
    Xor2(Schnittstelle* input0, Schnittstelle* input1, Schnittstelle* output0)
    {
        this->name = "Xor2";
        addInput(input0);
        addInput(input1);
    ...
    void update()
    {
        if ((input[0]->getPegel() == Schnittstelle::LOW && input[1]->getPegel() == Schnittstelle::LOW)
            || (input[0]->getPegel() == Schnittstelle::HIGH && input[1]->getPegel() == Schnittstelle::HIGH))
        {
            output[0]->setPegel(Schnittstelle::LOW);
        }
        else if (((input[0]->getPegel() == Schnittstelle::HIGH && input[1]->getPegel() == Schnittstelle::LOW) || (input[0]->getPegel() == Schnittstelle::LOW && input[1]->getPegel() == Schnittstelle::HIGH))
